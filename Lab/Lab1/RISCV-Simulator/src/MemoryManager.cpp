...
bool MemoryManager::setByte(uint32_t addr, uint8_t val, uint32_t *cycles, uint64_t pc)
{
...
uint8_t MemoryManager::getByte(uint32_t addr, uint32_t *cycles, uint64_t pc)
{
  if (!this->isAddrExist(addr))
  {
...
bool MemoryManager::setShort(uint32_t addr, uint16_t val, uint32_t *cycles, uint64_t pc)
{
  if (!this->isAddrExist(addr))
  {
...
uint16_t MemoryManager::getShort(uint32_t addr, uint32_t *cycles, uint64_t pc)
{
...
bool MemoryManager::setInt(uint32_t addr, uint32_t val, uint32_t *cycles, uint64_t pc)
{
  if (!this->isAddrExist(addr))
  {
...
uint32_t MemoryManager::getInt(uint32_t addr, uint32_t *cycles, uint64_t pc)
{
  uint32_t b1 = this->getByte(addr, cycles);
  uint32_t b2 = this->getByte(addr + 1);
...
bool MemoryManager::setLong(uint32_t addr, uint64_t val, uint32_t *cycles, uint64_t pc)
{
  if (!this->isAddrExist(addr))
  {
...
uint64_t MemoryManager::getLong(uint32_t addr, uint32_t *cycles, uint64_t pc)
{
